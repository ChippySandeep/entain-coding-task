...
[Node.js](https://docs.npmjs.com/dnpm installownloading-and-installing-node-js-and-npm) and [npm](https://docs.npmjs.com/downloading-and-installing-node-js-and-npm) are required to run the Next To Go web app and Cypress.

## Setup

Run ```npm install``` inside the project repository.
Run ```install -D cypress-xpath``` to install xpath
## Running the Next To Go web app

Run ```npm run start``` inside the project repository.

## Running Cypress
Need to install xpath to run the test sceessefully
